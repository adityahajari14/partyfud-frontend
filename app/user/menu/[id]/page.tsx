            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-stretch">
                    ...
                    <div className="flex flex-col">
                        <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100/50 p-8 flex flex-col h-full">
                            <h2 className="text-base font-black text-gray-900 flex items-center gap-3 uppercase tracking-widest mb-8">
                            ...
                            <div className="flex flex-col gap-6">
                                <div className="flex flex-col gap-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-[#268700] text-sm font-black transition-all outline-none appearance-none cursor-pointer"
                                    >
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="w-full pl-14 pr-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-[#268700] text-sm font-black transition-all outline-none appearance-none cursor-pointer"
                                        >
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-14 pr-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-[#268700] text-sm font-black transition-all outline-none"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-14 pr-6 py-4 rounded-2xl bg-gray-50 border border-transparent focus:bg-white focus:border-[#268700] text-sm font-black transition-all outline-none cursor-pointer"
                                        />
                                    </div>
                                </div>
                            </div>
