...
import { Eye, Calendar, MapPin, Users, DollarSign, FileText, Building2, X } from 'lucide-react';
...
export default function ProposalsPage() {
  ...
  const fetchProposals = async () => {
    ...
    setError(null);
    try {
      const response = await userApi.getProposals();
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            {proposals.length === 0 
              ...
              : `${proposals.length} ${proposals.length === 1 ? 'proposal' : 'proposals'} found`}
          </p>
        </div>
        ...
        {proposals.length === 0 ? (
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">Request a custom proposal from a caterer to get started</p>
            <Link
              href="/user/caterers"
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600">
                        <div className="flex items-center gap-1">
                          <Building2 size={16} />
                          <span>{proposal.caterer.name}</span>
                        </div>
                        <div className="flex items-center gap-1">
                          <Calendar size={16} />
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-8">
              ...
              <div className="mb-6 pb-6 border-b border-gray-200">
                ...
                <p className="text-gray-600">Caterer: <span className="font-medium">{selectedProposal.caterer.name}</span></p>
              </div>
